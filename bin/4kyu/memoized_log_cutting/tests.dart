...
//         0    1    2    3    4    5    6    7... and so on
  var p = [ 0, 1, 5, 8, 9, 10, 17, 17, 20, 24, // 0X's
    ...
    151, 125, 129, 131, 134, 135, 140, 143, 145, // 4X's
    151, 125, 129, 131, 134, 135, 140, 143, 145, // 4X's
    151, 125, 129, 131, 134, 135, 140, 143, 145, // 4X's
    151, 125, 129, 131, 134, 135, 140, 143, 145, // 4X's
    151, 125, 129, 131, 134, 135, 140, 143, 145, // 4X's
...
// Note that the 0th element has a cost of $0
  group("Example Log", () {
    ...
    test("The optimal price for n = 50 should be \$153", () =>
        expect(cutLog(p, 80), equals(246)));
    test("The optimal price for n = 50 should be \$153", () =>
        expect(cutLog(p, 100), equals(306)));
    test("The optimal price for n = 50 should be \$153", () =>
        expect(cutLog(p, 150), equals(461)));
    test("The optimal price for n = 50 should be \$153", () =>
        expect(cutLog(p, 200), equals(615)));
    test("The optimal price for n = 50 should be \$153", () =>
        expect(cutLog(p, 365), equals(1122)));
  });
